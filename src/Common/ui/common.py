...
from PyQt6.QtCore import QSize, QSortFilterProxyModel, Qt, QBasicTimer, pyqtSignal, QTimer, QPropertyAnimation, QEasingCurve
...
class QBadgeButton(QPushButton):
    ...
    def drawBadge(self, painter, x, y, size, text, brush):
        ...
        painter.drawText(x, y, size - 2, size - 2, Qt.AlignmentFlag.AlignCenter, text)
